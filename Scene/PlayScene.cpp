...
void PlayScene::Draw() const {
		IScene::Draw();
		Engine::Image baroutline("play/baroutline.png", 1291, 699, (300), 20, 0, 0);
		baroutline.Draw();
		if(EnemyNum && 300*EnemyNum/allNum>=1) {
			Engine::Image bar("play/EnemyNumber.png", 1292, 700, (300*EnemyNum/allNum), 20, 0, 0);
			bar.Draw();
		}
		if (DebugMode) {
...
void PlayScene::ConstructUI() {
	...
	UIGroup->AddNewObject(new Engine::Label(std::string("Progress "), "pirulen.ttf", 32, 1294, 650));
	TurretButton* btn;
	// Button 1
	...
	btn = new TurretButton("play/floor.png", "play/dirt.png",
			...
			Engine::Sprite("play/turret-8.png", 1522, 136-11, 0, 0, 0, 0)
			, 1522, 136, ShapaTurret::Price);
	btn->SetOnClickCallback(std::bind(&PlayScene::UIBtnClicked, this, 3));
	UIGroup->AddNewControlObject(btn);
	//
	btn = new TurretButton("play/floor.png", "play/dirt.png",
			Engine::Sprite("play/shovel.png", 1294, 220, 0, 0, 0, 0),
			Engine::Sprite("play/shovel.png", 1294, 220, 0, 0, 0, 0)
			, 1294, 220, Shovel::Price);
